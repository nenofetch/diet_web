...
@section('title', 'Edit Riwayat Makan Pagi')
...
<div class="container-fluid">
    <div class="layout-specing">
        <div class="d-md-flex justify-content-between align-items-center">
            <h5 class="mb-0">Edit Riwayat Makan Pagi</h5>

            <nav aria-label="breadcrumb" class="d-inline-block">
                <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                    <li class="breadcrumb-item text-capitalize"><a href="{{ route('histories.breakfast') }}">Riwayat
                            Makan Pagi</a></li>
        ...
        <a href="{{ route('histories.breakfast') }}" class="btn btn-warning btn-sm mt-4"><i
        ...
        <div class="col-lg-12 mt-4">
            <div class="card">
                <div class="container">
                    <div class="card-body">
                        <form action="{{ route('histories.breakfast.update', $breakfast->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row mt-4">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">Nama Makanan <span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            placeholder="Nama Makanan" name="name" value="{{ $breakfast->name }}"
                                            autocomplete="name">
                                        @error('name')
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control @error('tgl_input') is-invalid @enderror"
                                            name="tgl_input" value="{{ $breakfast->tgl_input }}"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01"
                                            ...
                                            placeholder="Kalori" name="calories" value="{{ $breakfast->calories }}"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01"
                                            ...
                                            value="{{ $breakfast->carbohydrates }}" autocomplete="carbohydrates">
                                        @error('carbohydrates')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01"
                                            ...
                                            placeholder="Protein" name="protein" value="{{ $breakfast->protein }}"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01"
                                            ...
                                            name="fat" value="{{ $breakfast->fat }}" autocomplete="fat">
                                        @error('fat')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
    ...
    @if (Session::has('message'))
        swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "{{ route('histories.breakfast') }}";
            }
        });
    @endif
</script>
