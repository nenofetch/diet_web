...
@section('title', 'Edit Riwayat Cemilan')
...
<div class="container-fluid">
    <div class="layout-specing">
        <div class="d-md-flex justify-content-between align-items-center">
            <h5 class="mb-0">Edit Riwayat Cemilan</h5>

            <nav aria-label="breadcrumb" class="d-inline-block">
                <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                    <li class="breadcrumb-item text-capitalize"><a href="{{ route('histories.snack') }}">Riwayat
                            Cemilan</a></li>
        ...
        <a href="{{ route('histories.snack') }}" class="btn btn-warning btn-sm mt-4"><i
        ...
        <div class="col-lg-12 mt-4">
            <div class="card">
                <div class="container">
                    <div class="card-body">
                        <form action="{{ route('histories.snack.update', $snack->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row mt-4">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">Nama Cemilan <span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            placeholder="Nama Cemilan" name="name" value="{{ $snack->name }}"
                                            autocomplete="name">
                                        @error('name')
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control @error('tgl_input') is-invalid @enderror"
                                            name="tgl_input" value="{{ $snack->tgl_input }}" autocomplete="tgl_input">
                                        @error('tgl_input')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01"
                                            ...
                                            placeholder="Kalori" name="calories" value="{{ $snack->calories }}"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01"
                                            ...
                                            value="{{ $snack->carbohydrates }}" autocomplete="carbohydrates">
                                        @error('carbohydrates')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01"
                                            ...
                                            placeholder="Protein" name="protein" value="{{ $snack->protein }}"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01"
                                            ...
                                            name="fat" value="{{ $snack->fat }}" autocomplete="fat">
                                        @error('fat')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
    ...
    @if (Session::has('message'))
        swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "{{ route('histories.snack') }}";
            }
        });
    @endif
</script>
